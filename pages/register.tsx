...
//     const formik: FormikProps<FormRegister> = useFormik({
//         initialValues: {
//             namaLengkap: '',
//             email: '',
//             password: '',
...
//                     />
//                 </div>
//                 <div className='flex flex-col justify-around p-4 border rounded-sm shadow-custom'>
...
//                         </p>
//                     </div>
//                     <form onSubmit={formik.handleSubmit} className="flex flex-col gap-3 px-10 my-8">
//                         <label
//                             htmlFor="nama"
